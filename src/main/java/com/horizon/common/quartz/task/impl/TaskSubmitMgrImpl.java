...
public class TaskSubmitMgrImpl implements BatchMgr {
	...
	private static final String shell = "/usr/local/spark-2.3.6/bin/spark-submit --master yarn-client  --num-executors 2 --driver-memory 2g --executor-memory 2g --executor-cores 2 ";
